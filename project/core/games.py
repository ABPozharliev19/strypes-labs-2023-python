...
class GamesManager:
    ...
    def get(self) -> List[Entity]:
        ...
        Returns:
            List[Entity]
        """
        return self.db.get_entities_by_type(GAMES)
    ...
    def get_by_id(self, identifier: int) -> Optional[Entity]:
        ...
        Returns:
            List[Entity]
        """
        return self.db.get_entity_by_id(GAMES, identifier)

    def update_by_id(self, identifier: int, new_values: EntityType) -> bool:
        entity = self.db.get_entity_by_id(GAMES, identifier)
        ...
        self.db.update_entity_by_id(GAMES, identifier, entity)
    ...
    def delete_by_id(self, identifier: int) -> bool:
        ...
        """
        return self.db.delete_entity_by_id(GAMES, identifier)

    def create_entity(self, new_values: EntityType):
        return self.db.create_entity(GAMES, new_values)
